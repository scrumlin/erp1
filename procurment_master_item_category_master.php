...
// die();
		...
		$check="SELECT * FROM item_category_master WHERE code='$code'";
		$result = db_query($check);
		 $checkrows=mysqli_num_rows($result); 
		    if($checkrows>0) {
		        ...
		        window.close();
		        window.location.href='procurment_master_item_category_master.php';
		    </script>
		    <?php 		     
		   } else {  
		    //insert results from the form input
		      $query = "INSERT INTO `item_category_master`(`code`, `name`, `creation_date`, `created_by`) VALUES('$code','$name','$creation_date','$uid')";
		      // print_r($query);
		      // die(); 
		      $result = db_query($query);
		      header("location:procurment_master_item_category_master.php");
...
<head>
    ...
    <body>
        ...
        <div class="main-wrapper">		
					...
					<div class="page-header">
						...
						<div class="row">
							...
							<div class="col-sm-7 col-auto">
								...
								<h3 class="page-title">Item Category Master</h3>
							...
							<div class="col-sm-5 col">
								...
								<a href="#add_item_category" data-toggle="modal" class="btn top-right-button float-right mt-2">Add Item Category</a>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												<?php
													$sql_fetch="SELECT * FROM item_category_master ORDER BY code DESC";
													...
													<td class="text-right">
														...
														<div class="actions">
															...
															<a data-id="<?php echo $id;?>" class="btn btn-sm bg-success-light edit-btn" 
																onclick="show_itemmodal('<?php echo $id;?>')" ><i class="fe fe-pencil"></i> Edit</a>
			...
			<div class="modal fade" id="add_item_category" aria-hidden="true" role="dialog">
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form action="procurment_master_item_category_master.php" method="POST">
								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-12">
										...
										<div class="form-group required">
											...
											<input type="text" class="form-control" placeholder="Enter  unit Code" name="code" readonly="readonly" value="<?php $last_no=0;
												$serial_no=0; 
												$seql = "SELECT * FROM item_category_master";
												$fetch_data = db_query($seql); 
										        if ($fetch_data ->num_rows > 0) 
										        { 
											        $fetch_maxn="SELECT MAX(id) AS serial_no FROM item_category_master";
			...
			<div class="modal fade" id="edit_item_category" aria-hidden="true" role="dialog">
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form action="" name="item_cat" id="item_cat">
    ...
    $sql1="SELECT * FROM item_category_master";
    // print_r($sql1);
    // die();
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								<form action="delete_item.php?id=<?php echo $id?>" method="post">
